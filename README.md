...
Esta herramienta fue creada específicamente para resolver problemas de inestabilidad en conexiones SMTP, donde los servidores suelen cortar la conexión, bloquear por exceso de errores o directamente algunas tools no sirven. 
